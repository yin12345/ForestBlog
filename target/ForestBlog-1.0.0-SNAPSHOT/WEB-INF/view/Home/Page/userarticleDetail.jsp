    ...
    <div class="article-floating-button-group">
        ...
        <div>
            <button id="share-button" class="circle-button">
                <i name="image" class="layui-icon layui-icon-share"></i>
            </button>
            <span id="share-label">分享</span>
        </div>
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
                    ...
                    <footer class="single-footer">
                        <ul class="single-meta">
                            <c:if test="${sessionScope.user.userId == article.user.userId}">
                                <li class="edit-link">
                                    <a target="_blank" class="post-edit-link" style="border: 0px"
                                       href="/admin/article/edit/${article.articleId}">
                                        <i class="layui-icon layui-icon-edit"></i>
                                    </a>
                                </li>
                            </c:if>

                            <li style="color: #999; margin-right: 10px;line-height: 32px">
                                <i>字数</i>
                                <span class="articleViewCount">
                                        ${article.articleContent.length()}
                                </span>
                            </li>

                            <li style="color: #999; line-height: 32px; margin-right: 5px">
                                    <%--class="views"--%>
                                <i>阅读</i>
                                    <%-- class="fa fa-eye"--%>
                                <span class="articleViewCount">
                            ...
                            <li style="color: #999; ">
                                <a href="/article/${article.articleId}#comments"
                                   rel="external nofollow" style="border: 0">
            ...
            <div class="single-tag">
                ...
                <%--            <div id="single-widget" style="width:100%">--%>
            ...
            <nav class="nav-single">
                <c:choose>
                    <c:when test="${preArticle!=null}">
                        <a href="/userarticle/${preArticle.articleId}" rel="next">
                            <span class="meta-nav">
                ...
                <c:choose>
                    <c:when test="${afterArticle!=null}">
                        <a href="/userarticle/${afterArticle.articleId}" rel="next">
                            <span class="meta-nav">
            ...
            <div id="comments" class="comments-area">
                <div id="respond" class="comment-respond">
                    ...
                    <form id="comment_form" method="post">
                        ...
                        <c:if test="${sessionScope.user == null}">
                            <text style="color: red">没有登录，不能评论</text>
                        </c:if>
                    </form>
                </div>
...
<rapid:override name="right">
    <%@include file="../Public/part/sidebar_article_detail.jsp" %>
</rapid:override>
<%--侧边栏 end--%>
